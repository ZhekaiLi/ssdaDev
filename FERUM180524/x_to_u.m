     ...
     for i = 1 : nrv
         switch marg(i,1)
            ...
            case 51 % Truncated normal marginal distribution
               z(i,:) = inv_norm_cdf( ferum_cdf(51,x(i,:),marg(i,5),marg(i,6),marg(i,7),marg(i,8)) ); 
            otherwise
         end
      end
      u = iLo * z;
