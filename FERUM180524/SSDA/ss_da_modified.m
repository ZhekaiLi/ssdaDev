function [ ssda_results, probdata ] = ss_da_modified(lsf,probdata,analysisopt,gfundata,femodel,randomfield)
   ...
   if ssda_Data.y ~= 0
      ...
      if ssda_restart_from_step < 0
         ...
         ssda_Data = ssda_step_modified(ssda_Data,num_sim,lsf,probdata,analysisopt,gfundata,femodel,randomfield);
      end
