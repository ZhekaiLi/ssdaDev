...
mu1 = 1.5; F = 27.5;
Mu  = [ mu1 0.01 1.00 0.01 0.05 0.02 F 100 ]';
...
% GP surrogate
GPmodel.ktype                = 'matern';   % kernal type: sqexp, ratquad, poly, matern
GPmodel.dim                  = 8;        % dimension of RVs
GPmodel.Nc                   = 2e3;      % size of the maximal training set
GPmodel.epic                 = 1e-4;     % innovation threshold
