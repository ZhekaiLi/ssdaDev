      ...
      for i = 1 : nrv
         switch marg(i,1)
            ...
            case 3  % Gamma distribution
               ...
               pdf1 = ferum_pdf(3,x(i),marg(i,5),marg(i,6));
            ...
            case 4  % Shifted exponential distribution
               ...
               pdf1 = ferum_pdf(4,x(i),marg(i,5),marg(i,6));
               pdf2 = ferum_pdf(1,z(i),0,1);
               J_z_x(i,i) = pdf1/pdf2;
            case 5  % Shifted Rayleigh distribution
               ...
               pdf1 = ferum_pdf(5,x(i),marg(i,5),marg(i,6));
               pdf2 = ferum_pdf(1,z(i),0,1);
               J_z_x(i,i) = pdf1/pdf2;
            case 6  % Uniform distribution
               ...
               %b = marg(i,6);
               %pdf1 = 1 / (b-a);
               pdf1 = ferum_pdf(6,x(i),marg(i,5),marg(i,6));
               pdf2 = ferum_pdf(1,z(i),0,1);
               J_z_x(i,i) = pdf1/pdf2;
            case 7  % Beta distribution
               ...
               pdf1 = ferum_pdf(7,x(i),marg(i,5),marg(i,6),marg(i,7),marg(i,8));
               pdf2 = ferum_pdf(1,z(i),0,1);
               J_z_x(i,i) = pdf1/pdf2;
            ...
            case 11 % Type I largest value distribution ( same as Gumbel distribution )
               ...
               pdf1 = ferum_pdf(11,x(i),marg(i,5),marg(i,6));
               pdf2 = ferum_pdf(1,z(i),0,1);
               J_z_x(i,i) = pdf1/pdf2;
            case 12 % % Type I smallest value distribution
               ...
               pdf1 = ferum_pdf(12,x(i),marg(i,5),marg(i,6));
               pdf2 = ferum_pdf(1,z(i),0,1);
               J_z_x(i,i) = pdf1/pdf2;
            case 13 % Type II largest value distribution
               ...
               pdf1 = ferum_pdf(13,x(i),marg(i,5),marg(i,6));
               pdf2 = ferum_pdf(1,z(i),0,1);
               J_z_x(i,i) = pdf1/pdf2;
            case 14 % Type III smallest value distribution
               ...
               pdf1 = ferum_pdf(14,x(i),marg(i,5),marg(i,6),marg(i,7));
               pdf2 = ferum_pdf(1,z(i),0,1);
               J_z_x(i,i) = pdf1/pdf2;
            case 15 % Gumbel distribution ( same as type I largest value distribution )
               ...
               %a_n = marg(i,6);
			   %pdf1 = a_n * exp( -a_n*(x(i)-u_n) - exp(-a_n*(x(i)-u_n)) );
               pdf1 = ferum_pdf(15,x(i),marg(i,5),marg(i,6));
               pdf2 = ferum_pdf(1,z(i),0,1);
               J_z_x(i,i) = pdf1/pdf2;
            case 16 % Weibull distribution ( same as Type III smallest value distribution with epsilon = 0 )
               ...
               pdf1 = ferum_pdf(16,x(i),marg(i,5),marg(i,6));
               pdf2 = ferum_pdf(1,z(i),0,1);
               J_z_x(i,i) = pdf1/pdf2;
            case 51  % Truncated normal marginal distribution
               pdf1 = ferum_pdf(51,x(i),marg(i,5),marg(i,6),marg(i,7),marg(i,8));
               pdf2 = ferum_pdf(1,z(i),0,1);
               J_z_x(i,i) = pdf1/pdf2;
            otherwise
         end
